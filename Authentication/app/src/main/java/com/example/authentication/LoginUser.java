                ...
                LAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(LoginUser.this, "Logged In Successfuly", Toast.LENGTH_LONG).show();
                            startActivity(new Intent(getApplicationContext(), User_Profile.class));
                        }else{
                            Toast.makeText(LoginUser.this, "Error occured ! "+ task.getException().getMessage(), Toast.LENGTH_LONG).show();
